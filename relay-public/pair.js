...
async function generateIdentity() {
  ...
  const keys = libsodium_wrappers_default.crypto_sign_keypair();
  return { publicKey: encode(keys.publicKey), privateKey: encode(keys.privateKey) };
}
async function createPairingRequest(params) {
  await initializeCrypto();
  ...
  return {
    ...
    proof: encode(libsodium_wrappers_default.crypto_auth(transcript, decode(params.pairingToken)))
  };
}
